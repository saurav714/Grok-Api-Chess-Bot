...
class ChessAutoPlayerGUI:
    ...
    def get_best_move(self, fen):
        try:
            ...
            # Parse response
            move_match = re.search(r"Best move: (\S+)", response_text, re.IGNORECASE)
...
if __name__ == "__main__":
    try:
        ...
        logger.info("Auto-Player application started")
        main()
